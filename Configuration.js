...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
   ...
   endpoints.addEndpoint("1", "Congelados 1", endpointType.temperatureSensor);
   endpoints.addEndpoint("2", "Congelados 2", endpointType.temperatureSensor);
   endpoints.addEndpoint("3", "Congelados 3", endpointType.temperatureSensor);
   endpoints.addEndpoint("4", "Refrigerados", endpointType.temperatureSensor);
