...
# Parsing + Configuration Script – MONMNGMQT4DC5 - Rev. A

This **Parsing + Configuration** script is designed for the **MONMNGMQT4DC5** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MONMNGMQT4DC5 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **MONMNGMQT4DC5** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
